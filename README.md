...
- [*About Optical neural network*](https://arxiv.org/search/?query=%22Optical+neural+network%22&searchtype=all&abstracts=show&order=-announced_date_first&size=50)
- [*Backpropagation*](https://arxiv.org/search/?query=%22Backpropagation%22&searchtype=all&abstracts=show&order=-announced_date_first&size=50)
